...
def pd_multiclass_nms(bboxes, scores, score_thr, nms_thr, keep_top_k):
    attrs = ("background_label",80,"score_threshold",score_thr,
            "nms_top_k",1000, "nms_threshold", nms_thr,
